...
public class JavaTest {
    ...
    public String make24Points(String cards,int x) {
...
//            }
    ...
    private void recursion(ArrayList<Double> d, ArrayList<String> s, int x) {
        int n = d.size();
        if (n == 1) {
            if (Math.abs(d.get(0) - x) <= 0.000000001) {    //防止有分数而产生误差
...
//              System.out.println(res);
    ...
    public static void main(String[] args) {
        ...
        String cards = "A K 9 8 4 3";
        int x=24;
        System.out.println("The method to make 24 points is: " + c.make24Points(cards, x));
    }
}
